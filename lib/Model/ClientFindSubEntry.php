...
/**
 * ClientFindSubEntry Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientFindSubEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClientFindSubEntry';
...
'disallowed_rule' => 'getDisallowedRule'    ];
     ...
     *
     * @param string $disallowed_rule The rule due to which the client is disallowed.  If disallowed is set to true, and this string is empty, then the client IP is disallowed by the \"allowed IP list\", that is it is not included in the allowed list.
     *
     * @return $this
     */
